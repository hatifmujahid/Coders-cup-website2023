        ...
        <div className="homeimg mt-8" style={{
          ...
          backgroundAttachment: "fixed"
            ...
            <div className="pt-16 flex flex-col justify-center items-center">
                ...
                <Link to={'register'}>
                  <div>
                    <button id= "glow" style={{fontFamily:"spotifyMedium"}} className=" hover:scale-105 z-2 mt-16 bg-white text-black py-3 px-10 rounded-full text-xl relative hover:bg-black hover:text-red-600 ease-in-out transition duration-300"> Register Today
                    </button>
